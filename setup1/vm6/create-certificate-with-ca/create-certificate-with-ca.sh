createcertificatesForOrg6() {
  ...
  fabric-ca-client enroll -u https://admin:adminpw@localhost:5054 --caname ca.org6.example.com --tls.certfiles ${PWD}/fabric-ca/org6/tls-cert.pem

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-5054-ca-org6-example-com.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:5054 --caname ca.org6.example.com -M ${PWD}/../crypto-config/peerOrganizations/org6.example.com/peers/peer0.org6.example.com/msp --csr.hosts peer0.org6.example.com --tls.certfiles ${PWD}/fabric-ca/org6/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:5054 --caname ca.org6.example.com -M ${PWD}/../crypto-config/peerOrganizations/org6.example.com/peers/peer0.org6.example.com/tls --enrollment.profile tls --csr.hosts peer0.org6.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org6/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:5054 --caname ca.org6.example.com -M ${PWD}/../crypto-config/peerOrganizations/org6.example.com/peers/peer1.org6.example.com/msp --csr.hosts peer1.org6.example.com --tls.certfiles ${PWD}/fabric-ca/org6/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:5054 --caname ca.org6.example.com -M ${PWD}/../crypto-config/peerOrganizations/org6.example.com/peers/peer1.org6.example.com/tls --enrollment.profile tls --csr.hosts peer1.org6.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org6/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://user1:user1pw@localhost:5054 --caname ca.org6.example.com -M ${PWD}/../crypto-config/peerOrganizations/org6.example.com/users/User1@org6.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org6/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://org6admin:org6adminpw@localhost:5054 --caname ca.org6.example.com -M ${PWD}/../crypto-config/peerOrganizations/org6.example.com/users/Admin@org6.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org6/tls-cert.pem
